...
for folder, size in (
    ...
    art = source.resize((round(size * 0.57), round(size * 0.57)), Image.Resampling.LANCZOS)
...
foreground.alpha_composite(source.resize((198, 198), Image.Resampling.LANCZOS), (117, 117))
